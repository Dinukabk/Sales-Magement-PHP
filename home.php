    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sales and Stock Management System</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="barcode.php"><span class="glyphicon glyphicon-record" aria-hidden="true"></span> Barcode</a>
                    </li>
                    <li>
                        <a href="sup.php"><span class="glyphicon glyphicon-record" aria-hidden="true"></span>add suplier</a>
                    </li>
                        <li>
                        <a href="cus.php"><span class="glyphicon glyphicon-record" aria-hidden="true"></span> add customer</a>
                    </li>
