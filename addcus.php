                ...
                <div class="row-fluid">
                    ...
                    <div class="hero-unit-3">
                        <ul class="thumbnails">
                            <li class="span7">
                                <div class="thumbnail">
                                    <div class="alert alert-info"><i class="icon-plus-sign-alt icon-large"></i>&nbsp;Add Your Virtual heare</div>
                                    ...
                                    if (isset($_POST['save'])) {
                                        ...
                                        mysqli_query($conn,"insert into  cus (name,contact,mail) values ('$un','$p','$fn',)")or die(mysqli_error());
